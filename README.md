...
The design targets the Terasic DE10-Lite and operates from its **50 MHz system clock**, supporting **115200-baud, 8-N-1 UART communication**. Post-fit static timing analysis using Intel TimeQuest achieved timing closure across 3/3 analyzed PVT corners, with a **+15.193 ns worst-case setup slack, +0.152 ns worst-case hold slack, and 0.000 ns total negative slack for both setup and hold analysis**.
...
[View assertion report](reports/assertion_report/UART_Pipeline_Assertion_Report.txt)
...
[View manual coverage report](reports/manual_coverage_report/manual_coverage_report.txt)
